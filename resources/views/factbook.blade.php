...
<html lang="{{ app()->getLocale() }}" style="width: 100%; background-color: #4E070B">
    <head>
        ...
        <meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-inline' public.tableau.com public.tableausoftware.com publicstatic.tableausoftware.com www.google-analytics.com www.google.com fonts.googleapis.com fonts.gstatic.com maps.googleapis.com www.youtube.com *.iro.ntnu.edu.tw:*">
        ...
        <script src='/js/tableau_view.js' ></script>
        <style>
        h2 {
            position: relative;
            display: inline; 
