...
export default class Population extends React.Component {
  ...
  componentDidMount() {
    // console.log(this);
    window.getLoginAndInitViz('views/FactBook/Population', this.vizContainer);

    // const divElement = document.getElementById('viz1520924954099');
    ...
    return (
      <div className={this.props.classes.content}>
        ...
        <Typography variant="display1" paragraph style={{width: this.props.textWidth}}>
          {'The overall population about our teacher, student, faculty and staff. You can select or deselect any of the affiliation by click the color legend, or the checkbox if browsing on bigger device like desktop or tablet.'}
        </Typography>

        <div ref={(div) => { this.vizContainer = div; }}></div>
        
        {/* <div className='tableauPlaceholder' id='viz1520924954099' 
        ...
        >
          <noscript>
            <a href='#'>
              <img alt='Population' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Fa&#47;FactBook-Population&#47;Population&#47;1_rss.png' style={{border: 'none' }}/>
            </a>
          </noscript>
          <object className='tableauViz' style={{ display: 'none' }} >
            ...
            <param name='name' value='FactBook-Population&#47;Population' />
            <param name='tabs' value='no' />
            <param name='toolbar' value='yes' />
            <param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Fa&#47;FactBook-Population&#47;Population&#47;1.png' /> 
