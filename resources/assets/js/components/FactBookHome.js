...
export default class FactBookHome extends Component {
    constructor() {
        super();
        this.state = {
            someData: null,
        ...
        ReactGA.initialize('UA-10706568-2', { debug: true });
...
if (document.getElementById('main')) {
    ReactDOM.render(<FactBookHome />, document.getElementById('main'));
}